...
template<> IRNodeType ExprNode<IntImm>::_node_type = {};
template<> IRNodeType ExprNode<FloatImm>::_node_type = {};
template<> IRNodeType ExprNode<StringImm>::_node_type = {};
template<> IRNodeType ExprNode<Cast>::_node_type = {};
template<> IRNodeType ExprNode<Variable>::_node_type = {};
template<> IRNodeType ExprNode<Add>::_node_type = {};
template<> IRNodeType ExprNode<Sub>::_node_type = {};
template<> IRNodeType ExprNode<Mul>::_node_type = {};
template<> IRNodeType ExprNode<Div>::_node_type = {};
template<> IRNodeType ExprNode<Mod>::_node_type = {};
template<> IRNodeType ExprNode<Min>::_node_type = {};
template<> IRNodeType ExprNode<Max>::_node_type = {};
template<> IRNodeType ExprNode<EQ>::_node_type = {};
template<> IRNodeType ExprNode<NE>::_node_type = {};
template<> IRNodeType ExprNode<LT>::_node_type = {};
template<> IRNodeType ExprNode<LE>::_node_type = {};
template<> IRNodeType ExprNode<GT>::_node_type = {};
template<> IRNodeType ExprNode<GE>::_node_type = {};
template<> IRNodeType ExprNode<And>::_node_type = {};
template<> IRNodeType ExprNode<Or>::_node_type = {};
template<> IRNodeType ExprNode<Not>::_node_type = {};
template<> IRNodeType ExprNode<Select>::_node_type = {};
template<> IRNodeType ExprNode<Load>::_node_type = {};
template<> IRNodeType ExprNode<Ramp>::_node_type = {};
template<> IRNodeType ExprNode<Broadcast>::_node_type = {};
template<> IRNodeType ExprNode<Call>::_node_type = {};
template<> IRNodeType ExprNode<Let>::_node_type = {};
template<> IRNodeType StmtNode<LetStmt>::_node_type = {};
template<> IRNodeType StmtNode<AssertStmt>::_node_type = {};
template<> IRNodeType StmtNode<Pipeline>::_node_type = {};
template<> IRNodeType StmtNode<For>::_node_type = {};
template<> IRNodeType StmtNode<Store>::_node_type = {};
template<> IRNodeType StmtNode<Provide>::_node_type = {};
template<> IRNodeType StmtNode<Allocate>::_node_type = {};
template<> IRNodeType StmtNode<Free>::_node_type = {};
template<> IRNodeType StmtNode<Realize>::_node_type = {};
template<> IRNodeType StmtNode<Block>::_node_type = {};
template<> IRNodeType StmtNode<IfThenElse>::_node_type = {};
template<> IRNodeType StmtNode<Evaluate>::_node_type = {};
